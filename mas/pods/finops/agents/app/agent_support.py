...
AGENT_CAPABILITIES: dict[str, dict[str, Any]] = {
    "cluster_state": {
        ...
        "fields": {
            ...
            "scale_target_current_pods": ["result.scale_target_current_pods"],
    ...
    "demand_shaping": {
        ...
        "fields": {
            ...
            "per_minute_general": ["result.per_minute_general"],
            "per_second_general": ["result.per_second_general"],
    ...
    "traffic_forecast": {
        ...
        "fields": {
            ...
            "current_pods": [
                "result.current_pods",
                "candidate_forecasts[0].current_pods",
            ],
            "scale_out_pods": [
                "result.scale_out_pods",
                "candidate_forecasts[0].scale_out_pods",
            ],
            "vip_peak_rps": [
                "result.vip_peak_rps",
                "candidate_forecasts[0].vip_peak_rps",
            ],
            "general_peak_rps": [
                "result.general_peak_rps",
                "candidate_forecasts[0].general_peak_rps",
            ],
            "per_minute_general": [
                "result.per_minute_general",
                "candidate_forecasts[0].per_minute_general",
            ],
            "per_second_general": [
                "result.per_second_general",
                "candidate_forecasts[0].per_second_general",
            ],
    ...
    "bottleneck_capacity": {
        ...
        "fields": {
            ...
            "required_pods": ["result.required_pods"],
            "pod_readiness_ratio": ["result.pod_readiness_ratio"],
            "pod_readiness_percent": ["result.pod_readiness_percent"],
            "pod_readiness_warning": ["result.pod_readiness_warning"],
            "current_rps": ["result.current_rps"],
            "peak_rps_forecast": ["result.peak_rps_forecast"],
            "estimated_rds_cpu_at_peak": ["result.estimated_rds_cpu_at_peak"],
            "db_risk": ["result.db_risk"],
    ...
    "infra_execution": {
        ...
        "fields": {
            ...
            "candidate_capacity_plans": ["result.candidate_capacity_plans"],
            "idle_resource_plan": ["result.idle_resource_plan"],
            "idle_resource_saving_usd": ["result.idle_resource_saving_usd"],
            "scale_out_pods": ["result.scale_out_pods"],
            ...
            "nodegroup_capacity_check": ["result.nodegroup_capacity_check"],
            "approval_required_actions": ["result.approval_required_actions"],
            "cost_optimization_hints": ["result.cost_optimization_hints"],
            "spot_policy": ["result.spot_policy"],
    ...
    "unit_economics": {
        ...
        "fields": {
            ...
            "expected_business_value_usd": ["result.expected_business_value_usd"],
            "gross_cost_usd": ["result.gross_cost_usd"],
            "idle_saving_usd": ["result.idle_saving_usd"],
            "net_cost_usd": ["result.net_cost_usd"],
            "cost_to_value_percent": ["result.cost_to_value_percent"],
            "value_per_dollar": ["result.value_per_dollar"],
            "candidate_economics": ["result.candidate_economics"],
            "selected_candidate_label": ["result.selected_candidate_label"],
            "economic_assessment": ["result.economic_assessment"],
    ...
    "cost": {
        ...
        "fields": {
            ...
            "push": ["result.push"],
            "total": ["result.total"],
            "gross_estimated_cost_usd": ["result.gross_estimated_cost_usd"],
            "estimated_cost_usd": [
            ...
            "net_budget_exceeded": ["result.net_budget_exceeded"],
            ...
            "idle_resource_saving_usd": ["result.idle_resource_saving_usd"],
            "net_cost_after_idle_reduction": [
                "result.net_cost_after_idle_reduction",
                "candidate_costs[0].net_cost_after_idle_reduction",
            ],
            "idle_candidates": ["result.idle_candidates"],
            "idle_resource_plan": ["result.idle_resource_plan"],
            "cost_optimization_summary": ["result.cost_optimization_summary"],
