...
resource "aws_s3_bucket" "terraform_state" {
  ...
  tags = {
    Name      = "ilpumjinro-terraform-state"
    Project   = "ilpumjinro"
    ManagedBy = "terraform"
...
resource "aws_s3_bucket" "cloudtrail_logs_locked" {
  bucket              = "ilpumjinro-cloudtrail-logs-locked"
  object_lock_enabled = true
  lifecycle {
    prevent_destroy = false
  }
  tags = {
    Name      = "ilpumjinro-cloudtrail-logs-locked"
    Project   = "ilpumjinro"
    ManagedBy = "terraform"
    ...
    Statement = [
      {
        ...
        Resource = "arn:aws:s3:::ilpumjinro-cloudtrail-logs-locked"
      },
      {
        ...
        Action   = "s3:PutObject"
        Resource = "arn:aws:s3:::ilpumjinro-cloudtrail-logs-locked/AWSLogs/218549830271/*"
        Condition = {
          StringEquals = {
