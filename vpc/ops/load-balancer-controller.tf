# IAM permissions for the AWS Load Balancer Controller deployed by Argo CD.
# The Pod Identity association can be created before the ServiceAccount exists.
...
resource "aws_iam_policy" "aws_load_balancer_controller" {
  ...
  description = "Permissions for the AWS Load Balancer Controller in the Ops EKS cluster"
